...
Plans:
- [ ] 02-01: Ground effect over segmented-impedance profiles (spherical-wave reflection coefficient, soft↔hard, complex pressure)
- [ ] 02-02: Screen/multi-edge diffraction + complex contribution combination; ground+screen FORCE cases green
...
|-------|----------------|--------|-----------|
| 1. FORCE Harness, Geometry Model & Direct Path | 0/3 | Not started | - |
