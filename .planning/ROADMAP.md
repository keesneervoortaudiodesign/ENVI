...
- [ ] 02-01-PLAN.md — Nord2000-native numerics core: Faddeeva w(ẑ) + Fresnel fits, Ẑ_G→Q̂ chain + ρᵢ, straight-ray Δτ (cancellation-free), coherence F with FΔν seam; committed scipy oracle (ENG-02, ENG-07)
...
| 2. Ground Effect & Diffraction | 0/5 | Planned | - |
